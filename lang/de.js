...
Object.assign(de, {
    ...
    trademarkText_line2: 'Entwickelt vom RAM ',
    ...
    gameOptimizerTitle: 'Gaming-Leistungsoptimierer',
    gameOptimizerDesc: 'Erweiterter Gaming-Leistungsoptimierer, der Windows-Einstellungen anpasst, unnötige Dienste deaktiviert und die Gaming-Leistung maximiert mit voller Wiederherstellungsfunktion.',
    gameOptimizerTry: 'Jetzt ausprobieren',
    gameOptimizerCode: 'Code anzeigen',
    gameOptimizerDownload: 'Programm herunterladen',
    gameOptimizerOptimize: 'Leistung optimieren',
    gameOptimizerRestore: 'Einstellungen wiederherstellen',
    gameOptimizerBackup: 'Backup erstellen',
    gameOptimizerStatus: 'Status:',
    gameOptimizerReady: 'Bereit',
    gameOptimizerOptimizing: 'Optimiere...',
    gameOptimizerRestoring: 'Stelle wieder her...',
    gameOptimizerSuccess: 'Optimierung erfolgreich abgeschlossen!',
    gameOptimizerRestored: 'Einstellungen erfolgreich wiederhergestellt!',
    gameOptimizerBackupSuccess: 'Backup erfolgreich erstellt!',
    ...
    // Age Calculator
    ageCalculatorTitle: 'Altersrechner und Geburtstagscountdown',
    ageCalculatorImageAlt: 'Vorschaukarte des Altersrechners und Geburtstags-Countdowns',
    discordBotTitle: 'Discord- und verifizierte Bot-Projekte',
    discordBotDesc: 'Ich bin ein Entwickler auf Discord und habe Projekte, die von der Plattform selbst dokumentiert wurden, darunter Verified-App-Bots sowie erfolgreiche Projekte auf WhatsApp und Telegram.',
    discordBotLink: 'Top.gg-Bot-Link',
    discordBotCode: 'Projekte anzeigen',
    discordBotNote: 'Verifizierte Apps, dokumentierte Projekte und aktive Bot-Einsätze',
    discordBotImageAlt: 'Vorschaukarte für Discord-Bot- und Verified-App-Projekte',
    ageCalculatorDesc: 'Intelligenter Altersrechner mit Echtzeit-Geburtstagscountdown. Berechnen Sie Ihr Alter in Jahren, Monaten und Tagen und verfolgen Sie die verbleibenden Tage bis zu Ihrem nächsten Geburtstag.',
    ageCalculatorTry: 'Jetzt testen',
    ageCalculatorCode: 'Code anzeigen',
    ageCalculatorSelectDate: 'Wählen Sie Ihr Geburtsdatum',
    ageCalculatorSelectDatePrompt: 'Bitte wählen Sie ein Geburtsdatum',
    ageCalculatorToday: 'Heute',
    ageCalculatorCalculate: 'Mein Alter berechnen',
    ageCalculatorYourAge: 'Ihre Altersaufschlüsselung',
    ageCalculatorYears: 'Jahre',
    ageCalculatorMonths: 'Monate',
    ageCalculatorDays: 'Tage',
    ageCalculatorTotalDays: 'Gesamttage',
    ageCalculatorBirthdayCountdown: 'Geburtstagscountdown',
    ageCalculatorStart: 'Countdown starten',
    ageCalculatorDaysUntil: 'Tage bis zu Ihrem Geburtstag',
    ageCalculatorHours: 'Stunden',
    ageCalculatorMinutes: 'Minuten',
    ageCalculatorSeconds: 'Sekunden',
    ageCalculatorBirthdayToday: '🎉 Heute ist Ihr Geburtstag! Alles Gute zu Ihrem besonderen Tag! 🎉',
    ageCalculatorBirthdayOn: 'Ihr Geburtstag ist am',
});
